...
pos=ngramGenerator.mostFreqList('../data/positive_processed_small.csv',5)
positive=[w[0] for w in pos]
neg=ngramGenerator.mostFreqList('../data/negative_processed_small.csv',5)
negative=[w[0] for w in neg]
neu=ngramGenerator.mostFreqList('../data/neutral_processed_small.csv',5)
...
fo=open('../data/smallVectorTweets.csv','w')
mapper('../data/negative_processed_small.csv','0')
print 'negative file mapped'


print "Mapping positive file ..."
mapper('../data/positive_processed_small.csv','4')
print 'positive file mapped'


print "Mapping neutral file..."
mapper('../data/neutral_processed_small.csv','2')
